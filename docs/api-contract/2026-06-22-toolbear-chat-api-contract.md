...
状态：实现前 API contract（v2.19，v4.4-aligned —— … + 2026-06-27 DM addendum：`POST /api/chat/dms`、详见 `docs/api-contract/2026-06-27-dm-api-contract-addendum.md`；+ 2026-06-30 internal addendum：Bot streaming + internal API，详见本文 §16）
日期：2026-06-22
...
- `docs/api-contract/2026-06-22-toolbear-chat-api-contract.md` §16：实现前 wire shape、认证边界、错误码、与既有 contract 的替换关系。
